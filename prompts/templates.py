...
COT_INSTRUCTIONS = """Assume you are a human expert in evaluating model predictions. For Chain of Thought (CoT) style answers, follow these steps:

1. First, identify the final answer from the prediction by looking for:
   - The last sentence that contains the answer
   - Any sentence that starts with "Therefore", "So", "Thus", "In conclusion", "The answer is", "Final answer"
   - If no such indicators exist, use the last complete sentence as the answer

2. Once you have extracted the answer, evaluate if it matches the ground truth by following these criteria:
   - Take it as granted that the Ground Truth is always correct
   - If the extracted answer indicates uncertainty (e.g., "I'm not sure", "possibly", "maybe"), "score" should be 0
   - If the extracted answer exactly matches the Ground Truth, "score" is 1
   - For numerical answers, "score" is 1 if the numbers match after rounding
   - If the extracted answer is self-contradictory, "score" must be 0
   - If the extracted answer is a concise and correct summary of the ground truth, "score" is 1
   - If ground truth contains a set of items, extracted answer must contain exactly same items
   - Otherwise, "score" is 0

### Output a JSON blob with three fields:
- "extracted_answer": the final answer identified from the prediction
- "explanation": brief explanation of your scoring decision
- "score": 1 or 0"""

COT_IN_CONTEXT_EXAMPLES = """Examples:
Question: "what is the height of the eiffel tower?"
Ground Truth: "324 meters"
Prediction: "Let's solve this step by step:
1. The Eiffel Tower was completed in 1889
2. It was designed by Gustave Eiffel
3. The tower's height including the spire is 324 meters
Therefore, the height of the Eiffel Tower is 324 meters."
Output: {"extracted_answer": "324 meters", "score": 1, "explanation": "The extracted answer matches the ground truth exactly"}

Question: "who won the 2023 nba finals?"
Ground Truth: "denver nuggets"
Prediction: "Let me analyze this:
1. The 2023 NBA Finals was between Denver Nuggets and Miami Heat
2. The series went for 5 games
I think it was the Denver Nuggets but I'm not entirely sure."
Output: {"extracted_answer": "Denver Nuggets but I'm not entirely sure", "score": 0, "explanation": "The extracted answer shows uncertainty"}

Question: "what were the last three movies directed by christopher nolan?"
Ground Truth: "oppenheimer, tenet, and dunkirk"
Prediction: "Let's break this down:
1. Christopher Nolan's most recent film was Oppenheimer (2023)
2. Before that, he directed Tenet (2020)
3. And before Tenet, he made Dunkirk (2017)
So the last three movies directed by Christopher Nolan were Oppenheimer, Tenet, and Dunkirk."
Output: {"extracted_answer": "Oppenheimer, Tenet, and Dunkirk", "score": 1, "explanation": "The extracted answer contains all the correct items in the right order"}

Question: "what is the state bird of california?"
Ground Truth: "california quail"
Prediction: "california valley quail"
Output: {"extracted_answer": "california valley quail", "score": 1, "explanation": "The prediction matches the ground truth as california quail is also known as california valley quail."}
"""

# Original templates remain unchanged for non-CoT evaluation
